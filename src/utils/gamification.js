...
export function getCurrentTransformationLevel(stats) {
  if (!stats) return { id: 1, name: 'Just Starting', difficulty: 'Beginner', rewardMessage: 'Your journey begins now.', taskChecks: [] };
  ...
  return { id: 1, name: 'Just Starting', difficulty: 'Beginner', rewardMessage: 'Your journey begins now.', taskChecks: [] };
}
