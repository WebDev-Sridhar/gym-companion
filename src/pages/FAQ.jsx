...
const faqData = [
  {
    ...
    questions: [
      {
        q: 'What is GymThozhan?',
        a: 'GymThozhan is your personal gym companion app. It generates a customized workout plan, a calorie-matched South Indian diet plan, tracks your progress, and keeps you motivated with XP, streaks, and transformation levels — all tailored to your body and goals.',
      },
      {
