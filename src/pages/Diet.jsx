      ...
      >
        ...
        {isPro ? (
          ...
          <>
            ...
            <ProLock message="Detailed macro breakdown (carbs, fats & macro bar)">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/[0.03] rounded-lg h-16" />
                <div className="bg-white/[0.03] rounded-lg h-16" />
              </div>
            </ProLock>
          </>
        ...
        >
          ...
          {isPro ? (
            ...
            <ProLock message="Supplement recommendations">
              <div className="space-y-3">
                <div className="bg-white/[0.03] rounded-lg p-3 h-16" />
                <div className="bg-white/[0.03] rounded-lg p-3 h-16" />
              </div>
            </ProLock>
          )}
