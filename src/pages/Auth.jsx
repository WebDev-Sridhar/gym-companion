      ...
      >
        ...
        <div className="text-center mb-10">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-14 h-14 rounded-xl overflow-hidden mb-0.5"
          >
            <img src="/logo2.png" alt="OwnGainz" className="w-full h-full object-cover" />
          </motion.div>
        ...
        <motion.button
          ...
          className="w-full py-3.5 bg-white text-black font-bold rounded-lg flex items-center justify-center gap-3 disabled:opacity-50 transition-opacity text-sm"
        >
          {loading ? (
