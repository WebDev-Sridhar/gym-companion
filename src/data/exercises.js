...
export const exercises = {
  ...
  legCurl: {
    ...
    videoId: '1Tq3QdYUuHs',
    instructions: 'Lie face down on the leg curl machine with the pad resting on the back of your ankles. Curl your heels toward your glutes by contracting your hamstrings. Squeeze at the top, then lower slowly to the starting position.',
    donts: [
      'Don\'t lift your hips off the pad',
      'Don\'t use momentum to swing the weight',
      'Don\'t extend your legs too fast on the way down',
    ],
  },
  legExtension: {
    id: 'leg-extension',
